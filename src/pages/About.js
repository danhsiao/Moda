    ...
    return (
        <div className="about-page">
            ...
            <div className="about-block">
                ...
                <p></p>
                <p><strong>All voices and perspectives are welcome at Moda Magazine. We are always looking for new members to contribute to our publication! If you are interested in being involved with Moda send an email at modamagaizneuw@gmail.com.</strong></p>
            </div>
        </div>
    );
}
